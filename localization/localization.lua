...
L["TRULY_UNEQUIP_ITEMS"] = "%s has enabled the 'Truly unequip items' mode. Do you want to enable it too?|n|n|cFFFF0000Clothing exchanged for tokens will be put in your inventory.|r"

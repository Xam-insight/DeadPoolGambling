...
L["TRULY_UNEQUIP_ITEMS"] = "%s has enabled the |cFFFFFF00Truly unequip items|r mode. Do you want to enable it too?|n|n|cFFFF0000Clothing exchanged for tokens will be put in your inventory.|r"
L["DEADPOOL_SELL_ITEM_WARNING"] = "While |cFFFFFF00Truly unequip items|r mode is enabled, this item cannot be sold. Would you like to disable |cFFFFFF00Truly unequip items|r mode?"

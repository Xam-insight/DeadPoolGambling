...
L["ENABLE_TRULY_UNEQUIP_ITEMS_ENABLED"] = "Truly unequips items"
...
L["ENABLE_TRULY_UNEQUIP_ITEMS_TOOLTIP"] = "Enables / disables truly putting|nyour character's armor items in the inventory|nwhen exchanging clothing for tokens."
...
L["TRULY_UNEQUIP_ITEMS"] = "%s has enabled the "..YELLOW_FONT_COLOR:GenerateHexColorMarkup().."Truly unequip items|r mode. Do you want to enable it too?|n|n|cFFFF0000Clothing exchanged for tokens will be put in your inventory.|r"
L["DEADPOOL_SELL_ITEM_WARNING"] = "While "..YELLOW_FONT_COLOR:GenerateHexColorMarkup().."Truly unequip items|r mode is enabled, this item cannot be sold. Would you like to disable "..YELLOW_FONT_COLOR:GenerateHexColorMarkup().."Truly unequip items|r mode?"

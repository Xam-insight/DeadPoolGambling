...
L["RESETGAME_DESC"] = "If the game initiator has left the group, you can reset the game.|n|nThis is also possible if you are the last remaining player."
L["RESETGAME_ASKING"] = "%s suggests resetting the game. Do you accept?"
L["RESETGAME_CONFIRM"] = "Do you want to reset the game?"
L["RESETGAME_STARTVOTE"] = "The game will be reset in a few seconds if fewer than half of the players refuse."
L["RESETGAME_DONE"] = "The game has been reset."
L["RESETGAME_CANCELLED"] = "The reset was not accepted by the players."
L["RESETGAME_TOOSOON"] = "You requested a reset too recently."
...
L["DEADPOOLCOLLUMNS_STATS_CREATOR"] = "Game creator"

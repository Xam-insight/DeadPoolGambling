...
L["RESETGAME_DESC"] = "Si l'initiateur de la partie a quitté le groupe vous pouvez réinitialiser la partie.|n|nSi vous êtes le dernier joueur également."
L["RESETGAME_ASKING"] = "%s propose de réinitialiser la partie. Acceptez-vous ?"
L["RESETGAME_CONFIRM"] = "Vous voulez réinitialiser la partie ?"
L["RESETGAME_STARTVOTE"] = "La partie sera réinitialisée dans quelques secondes si moins de la moitié des joueurs refusent."
L["RESETGAME_DONE"] = "La partie est réinitialisée."
L["RESETGAME_CANCELLED"] = "La réinitialisation n'a pas été acceptée par les joueurs."
L["RESETGAME_TOOSOON"] = "Vous avez demandé une réinitialisation trop récemment."
...
L["DEADPOOLCOLLUMNS_STATS_CREATOR"] = "Créateur de la partie"

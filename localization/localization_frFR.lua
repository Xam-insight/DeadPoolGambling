...
L["TRULY_UNEQUIP_ITEMS"] = "%s a activé le mode "..YELLOW_FONT_COLOR:GenerateHexColorMarkup().."Vraiment retirer les vêtements|r. Voulez-vous l'activer également\194\160?|n|n|cFFFF0000Les vêtements échangés contre des jetons seront placés dans votre inventaire.|r"
L["DEADPOOL_SELL_ITEM_WARNING"] = "Tant que le mode "..YELLOW_FONT_COLOR:GenerateHexColorMarkup().."Vraiment retirer les vêtements|r est activé, cet objet ne peut pas être vendu. Voulez-vous désactiver le mode "..YELLOW_FONT_COLOR:GenerateHexColorMarkup().."Vraiment retirer les vêtements|r\194\160?"
